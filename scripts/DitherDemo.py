...
def render_graph_Dither():
    ...
    g.create_pass('SwitchTAAMethod', 'Switch', {'count': 5, 'selected': 0, 'i0': 'DLSS', 'i1': 'TAA', 'i2': 'Accumulate', 'i3': 'FSR', 'i4': 'RayReconstruction'})
    ...
    g.add_edge('DLSSPass.output', 'SwitchTAAMethod.i0')
    g.add_edge('SwitchTAAMethod.out', 'ToneMapper.src')
    g.add_edge('FSR.output', 'SwitchTAAMethod.i3')
    g.add_edge('AccumulatePass.output', 'SwitchTAAMethod.i2')
    ...
    g.add_edge('RayReconstructionPass.output', 'SwitchTAAMethod.i4')
    ...
    g.add_edge('DitherTAA.colorOut', 'SwitchTAAMethod.i1')
...
# Scene
m.loadScene('../../Scene/WarriorScene1.pyscene')