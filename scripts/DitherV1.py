...
def render_graph_Dither():
    ...
    g.add_edge('VBufferLighting.color', 'RayReconstructionPass.diffAlbedo')
    g.add_edge('VBufferLighting.color', 'RayReconstructionPass.specAlbedo')
    ...
    g.add_edge('UnpackVBuffer.linearZ', 'RayReconstructionPass.specHitDist')
    g.add_edge('UnpackVBuffer.normalW', 'RayReconstructionPass.normal')
    g.add_edge('UnpackVBuffer.rasterZ', 'RayReconstructionPass.roughness')
