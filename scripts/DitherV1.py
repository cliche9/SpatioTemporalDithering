...
def render_graph_Dither():
    ...
    g.create_pass('DitherVBuffer', 'DitherVBuffer', {'useWhitelist': True, 'whitelist': 'Board,CollectInner,Collectible,Smoke,TransparentPlane1,'})
    ...
    g.add_edge('VBufferLighting.color', 'DitherTAA.colorIn')
