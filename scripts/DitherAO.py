...
def render_graph_DitherAO():
    ...
    g.add_edge('UnpackVBuffer.rasterZ', 'SVAO.gbufferDepth')
    g.add_edge('UnpackVBuffer.linearZ', 'SVAO.depth')
    g.add_edge('DitherVBuffer.color', 'Diffuse.I1')
    g.add_edge('UnpackVBuffer.faceNormalW', 'CompressNormals.normalW')
    g.add_edge('CompressNormals.normalOut', 'SVAO.normals')
    g.add_edge('SVAO.ao', 'CrossBilateralBlur.color')
    g.add_edge('UnpackVBuffer.linearZ', 'CrossBilateralBlur.linear depth')
